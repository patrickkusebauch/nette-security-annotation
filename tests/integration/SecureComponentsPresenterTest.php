...
class SecureComponentsPresenterTest extends \Codeception\TestCase\Test
{
    ...
    public function testComponentsTiedToAction()
    {
        $this->specify("Component can be created for allowed action", function() {
            $presenter = new \Kusebauch\NetteSecurityAnnotation\Tests\SecureComponentsPresenterDummy();
